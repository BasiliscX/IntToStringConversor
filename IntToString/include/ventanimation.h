 ...
 */void ConsoleClsX_Y(int X, int Y, int amount=ConsoleColumns()+1){
    HANDLE hConsole=GetStdHandle(STD_OUTPUT_HANDLE);
...
*/void ConsoleDLT(int velocity=10){for(int i=0;i<=ConsoleRows();i++){ConsoleClsX_Y(0,i);Pause(velocity);}PosXY(0,0);}
